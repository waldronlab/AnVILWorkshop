...
**3. [Notebooks]** interactive analysis interfaces such as Jupyter notebook, RStudio, and Galaxy       
...
Once you click the Hamburger button on the top left, you can open this drop-down
menu. Under Library section, you can see the list of Terra's major resources: Data,
Showcase, and Workflows.

![](images/menu.png){width=140px, height=300px} 


## [Data](https://app.terra.bio/#library/datasets)
![](images/datasets.png){width=500px, height=400px}

## [Showcase](https://app.terra.bio/#library/showcase)
![](images/showcase_tutorial.png){width=550px, height=400px}

## [Workflows](https://app.terra.bio/#library/code)
![](images/code_workflows.png){width=550px, height=400px}
