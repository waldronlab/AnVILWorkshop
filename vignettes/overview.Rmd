...
## AnVIL
In this workshop, we are focusing on Terra. Terra is the analysis platform part 
of AnVIL (Analysis, Visualization and Informatics Lab-space) project launched by NHGRI.

![](AnVIL_ecosystem.png)

## Terra
Here are main features Terra provides:   
